<%-- 
    ...
    Created on : Jun 19, 2024, 10:33:11 AM
    Author     : admin
--%>
    ...
    <head>
      ...
      <body>
        ...
        <div class="container mt-4">
            <div class="row">
                <% 
                    List<Movie> list = (List<Movie>) request.getAttribute("moviesearch");
                        ...
                        <div class="card-body">
                            ...
                            <div class="info-action">
                                ...
                                <form action="UserController" method="post" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn btn-success btn-sm">Book Tickets</button>
                                </form>
                            </div>
                        </div>
                    </div>
