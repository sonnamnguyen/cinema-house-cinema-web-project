 ...
 * @author ADMIN
 */
public class ChooseSeatSevelet extends HttpServlet {
     ...
     */
    private final String ChooseSeatPage = "chooseSeat.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (sessionTime != null && sessionDate != null && roomName != null) {
