 ...
 * @author admin
 */
public class SearchUserSevelet extends HttpServlet {
     ...
     */
            private final String ADMIN_USER_PAGES = "searchmembers.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String information = request.getParameter("Information");
            ...
            List<User> user = dao.searchInformation(information);
            if(user != null) {
